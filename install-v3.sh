...
rit_install () {
	...
	STABLE_VERSION=$(curl -s https://commons-repo.ritchiecli.io/stable.txt) #UPDATE URL for v3
	curl -SLO "https://commons-repo.ritchiecli.io/${STABLE_VERSION}/${OPERATIONAL_SYSTEM}/rit" #UPDATE URL for v3
