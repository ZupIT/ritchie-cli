...
func Build() *cobra.Command {
	...
	addRepoCmd := cmd.NewAddRepoCmd(repoAddLister, repoProviders, repoDeleter, inputTextValidator, inputPassword, inputURL, inputList, inputBool, inputInt, tutorialFinder, treeChecker, detailRepo)
