...
func Build() *cobra.Command {
	...
	ctxSetter := env.NewSetter(ritchieHomeDir, ctxFinder)
	ctxRemover := env.NewRemover(ritchieHomeDir, ctxFinder)
	ctxFindSetter := env.NewFindSetter(ritchieHomeDir, ctxFinder, ctxSetter)
	ctxFindRemover := env.NewFindRemover(ritchieHomeDir, ctxFinder, ctxRemover)
